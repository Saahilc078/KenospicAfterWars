...
// Scroll-based video playback controller
const video = document.getElementById("myVideo");

// Ensure metadata is loaded before using video.duration
video.addEventListener('loadedmetadata', function() {
  ...
  function syncVideoToScroll() {
    ...
    // set video time (syncs scroll percent to video duration)
    video.currentTime = video.duration * scrollFraction;

    // keep it smooth in active render cycle
